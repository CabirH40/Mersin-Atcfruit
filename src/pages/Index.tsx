    ...
    <div className="min-h-screen bg-white selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <section className="py-32 bg-emerald-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-7xl font-bold text-white mb-12 max-w-4xl mx-auto leading-tight">
      ...
      <a 
        ...
        className="fixed bottom-10 right-10 z-50 w-20 h-20 bg-green-500 text-white rounded-full flex items-center justify-center shadow-[0_10px_40px_rgba(34,197,94,0.4)] hover:scale-110 transition-transform animate-bounce-slow"
      >
